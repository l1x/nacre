...
impl IntoResponse for AppError {
    fn into_response(self) -> Response {
        let (status, user_message) = match &self {
            ...
            AppError::Beads(BeadsError::NotFound(msg)) => (StatusCode::NOT_FOUND, format!("Not found: {}", msg)),
            AppError::Beads(_) => (StatusCode::INTERNAL_SERVER_ERROR, "An internal error occurred".to_string()),
